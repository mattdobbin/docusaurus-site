...
<img src="/docusaurus-site/samples/direct-deposit.png" alt="The Enter Direct Deposit Information for UK Employees topic in it's original help portal built in MadCap Flare." style={{border: '1px solid black'}} />
